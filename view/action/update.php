<ul class="breadcrumb">
    ...
    <li class="active">修改权限项</li>
</ul>
<form id="actionForm" class="form-horizontal" action="?r=action/update" method="post">
        ...
        <div class="controls">
            <select id="pid" name="pid">
                ...
                <?php foreach ($parents as $parent) { ?>
                    <option value="<?php echo $parent['id']; ?>"<?php if ($parent['id'] == $action['parent_id']) { ?> selected="selected"<?php } ?>><?php echo $parent['name']; ?></option>
                <?php } ?>
            </select>
        </div>
    </div>
    ...
    <div class="control-group">
        ...
        <div class="controls">
            <input type="text" id="name" name="name" value="<?php echo $action['name']; ?>">
        </div>
    </div>
    <div class="control-group">
        <label class="control-label" for="info">权限描述</label>
        <div class="controls">
            <textarea class="input-xlarge" rows="4" id="info" name="info"><?php echo $action['info']; ?></textarea>
        </div>
    </div>
    <div class="control-group">
        <div class="controls">
